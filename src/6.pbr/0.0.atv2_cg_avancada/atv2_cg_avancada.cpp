...
bool copyFiles(const std::string& sourceDir, const std::string& destDir, const std::vector<std::string> fileNames) {
    try {
...
int main()
{
    copyFiles("../../../src/6.pbr/0.0.atv2_cg_avancada/", fs::current_path().string(), { "0.0.pbr.vs", "0.0.pbr.fs" });
    ...
    // -------------------------
    Shader shader("0.0.pbr.vs", "0.0.pbr.fs");
